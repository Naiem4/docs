...
<Card
  ...
  icon="building"
  href="/docs/api-reference/endpoint/get-business-info"
>
...
<Card
  ...
  icon="list"
  href="/docs/api-reference/endpoint/get-business-posts"
>
  Access customer Posts and ratings
    ...
    icon="star"
    href="/docs/api-reference/endpoint/get-business-reviews"
